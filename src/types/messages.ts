...
export function isIframeMessage(d: unknown): d is T.IframeToContentMessage { return typeof d === 'object' && d !== null && 'type' in d && ['REIS_READY', 'REIS_REQUEST_DATA', 'REIS_FETCH', 'REIS_ACTION', 'REIS_PEFBOT_VISIBILITY'].includes((d as any).type); }
...
export const Messages = {
    ...
    pefbotVisibility: (visible: boolean): T.PefBotVisibilityMessage => ({ type: 'REIS_PEFBOT_VISIBILITY', visible })
};
