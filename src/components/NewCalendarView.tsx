/**
 * NewCalendarView - Vertical calendar layout based on Figma inspiration.
 * 
...
export function NewCalendarView({ initialDate = new Date(), onEmptyWeek }: NewCalendarViewProps) {
    ...
    return (
        <div className="flex h-screen overflow-hidden flex-col font-dm bg-base-100">
            {/* Day headers - sticky */}
